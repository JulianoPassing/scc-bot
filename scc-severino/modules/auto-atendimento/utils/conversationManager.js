...
class ConversationManager {
  ...
  createConversation(channelId, userId, type) {
    this.conversations.set(channelId, {
      userId,
      type,
      step: 'initial', // initial, waiting_description, waiting_print, waiting_id, waiting_id_plate, waiting_alive_check, waiting_verification, waiting_boost_print, waiting_boost_id
      data: {},
      createdAt: new Date()
    });
  }
